...
Derived the analytical Fourier sine coefficients b_n for the step function initial intensity profile
...
Formulated the mathematical proof for the exponential decay (tau_n ~ 1/n^2) of higher spatial harmonics
Shaheem Ahammed:
Implemented the log scale harmonic decay analysis (Python) for assessing the continuous low-pass filtering effect across the spatial modes (n=1, 3, 5, 9, 15)
...
Compiled the Engineering conclusions, Physical interpretations of spatial blurring, and Reference list
